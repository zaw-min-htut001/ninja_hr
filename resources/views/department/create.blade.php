    ...
    <div class="py-5 mb-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg mb-[40px]">
                ...
                <form id="departments-form" action="{{ route('departments.store') }}" method="post">
                    @csrf
                    <div class="flex justify-center items-center">
                        <div class="">
                            <div class="w-7xl mt-3 mb-3">
                                <label class="block text-lg font-medium text-gray-700" for="name">Name</label>
                                <input name="title" id="name" type="text" class="form-input px-4 py-3 rounded  border-gray-300 focus:ring-black focus:border-black" />
                            </div>
                        </div>
                    </div>
