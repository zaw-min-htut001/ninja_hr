<x-app-layout>
    ...
    <div class="py-5 mb-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg mb-[40px]">
                ...
                <form id="roles-form" action="{{ route('roles.store') }}" method="post">
                    @csrf
                    ...
                    <div class="max-w-6xl grid md:grid-cols-3 lg:grid-cols-4 mx-3 gap-2">
                        ...
                        <label class="cursor-pointer">
                            ...
                            <input name='permissions[]' value="{{ $permission->name }}" type="checkbox" class="checkbox checkbox-xs" />
                        </label>
                        @endforeach
                      </div>
    ...
    {!! JsValidator::formRequest('App\Http\Requests\RoleRequest', '#roles-form'); !!}
<script>
